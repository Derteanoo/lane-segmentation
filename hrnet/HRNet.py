...
class HRNetV2(nn.Module):
    def __init__(self, class_num=5, **kwargs):
        ...
        self.stage2, pre_stage_channels = self._make_stage(
            self.stage2_cfg, num_channels, class_num=class_num)
        ...
        self.stage3, pre_stage_channels = self._make_stage(
            self.stage3_cfg, num_channels, class_num=class_num)
        ...
        self.stage4, pre_stage_channels = self._make_stage(
            self.stage4_cfg, num_channels, multi_scale_output=True, class_num=class_num)
        ...
        self.last_layer = nn.Sequential(
            nn.Conv2d(
                ...
                stride=1,
                padding=0),
            BatchNorm2d(class_num, momentum=BN_MOMENTUM),
    ...
    def _make_stage(self, layer_config, num_inchannels,
                    multi_scale_output=True,class_num=5):
    ...
    def forward(self, x, return_feature_maps=False):
        ...
        x = F.upsample(input=x, size=(x0_h*4, x0_w*4), mode='bilinear')
        return x


def hrnetv2(pretrained=False, **kwargs):
    model = HRNetV2(class_num=1000, **kwargs)
    if pretrained:
